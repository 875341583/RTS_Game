...
public partial class Unit3D : CharacterBody3D
{
    ...
    {
        UnitAbility.ArmorPiercing => TrManager.Tr("unit.ability.armor_piercing.name"),
        UnitAbility.DoubleShot => TrManager.Tr("unit.ability.double_shot.name"),
        UnitAbility.Scatter => TrManager.Tr("unit.ability.scatter.name"),
        UnitAbility.ReactiveArmor => TrManager.Tr("unit.ability.reactive_armor.name"),
        UnitAbility.SelfRepair => TrManager.Tr("unit.ability.self_repair.name"),
        UnitAbility.SmokeScreen => TrManager.Tr("unit.ability.smoke_screen.name"),
        UnitAbility.TurboEngine => TrManager.Tr("unit.ability.turbo_engine.name"),
        UnitAbility.ReconVision => TrManager.Tr("unit.ability.recon_vision.name"),
        UnitAbility.BattleFrenzy => TrManager.Tr("unit.ability.battle_frenzy.name"),
        UnitAbility.Plunder => TrManager.Tr("unit.ability.plunder.name"),
        UnitAbility.Tenacity => TrManager.Tr("unit.ability.tenacity.name"),
        _ => TrManager.Tr("unit.ability.unknown.name"),
    };

    public static string AbilityDesc(UnitAbility a) => a switch
    {
        UnitAbility.ArmorPiercing => TrManager.Tr("unit.ability.armor_piercing.desc"),
        UnitAbility.DoubleShot => TrManager.Tr("unit.ability.double_shot.desc"),
        UnitAbility.Scatter => TrManager.Tr("unit.ability.scatter.desc"),
        UnitAbility.ReactiveArmor => TrManager.Tr("unit.ability.reactive_armor.desc"),
        UnitAbility.SelfRepair => TrManager.Tr("unit.ability.self_repair.desc"),
        UnitAbility.SmokeScreen => TrManager.Tr("unit.ability.smoke_screen.desc"),
        UnitAbility.TurboEngine => TrManager.Tr("unit.ability.turbo_engine.desc"),
        UnitAbility.ReconVision => TrManager.Tr("unit.ability.recon_vision.desc"),
        UnitAbility.BattleFrenzy => TrManager.Tr("unit.ability.battle_frenzy.desc"),
        UnitAbility.Plunder => TrManager.Tr("unit.ability.plunder.desc"),
        UnitAbility.Tenacity => TrManager.Tr("unit.ability.tenacity.desc"),
        _ => "",
    };
}
